...
const applyFilter = (r,g,b, mode)=>{
  ...
  if(mode==='protan') return [r*0.566 + g*0.433 + b*0, r*0.558 + g*0.442 + b*0, r*0 + g*0.242 + b*0.758];
  if(mode==='deutan') return [r*0.625 + g*0.375 + b*0, r*0.7 + g*0.3 + b*0, r*0 + g*0.3 + b*0.7];
  if(mode==='tritan') return [r*0.95 + g*0.05 + b*0, r*0 + g*0.433 + b*0.567, r*0 + g*0.475 + b*0.525];
  return [r,g,b];
};
  ...
  useEffect(()=>{
    ...
    (async()=>{
      ...
      for(let i=0;i<d.length;i+=4){
        ...
        if(selectedIdx===null || minIdx===selectedIdx){
          // 강조 색상 그대로
        } else {
  ...
  return (
    <div style={{maxWidth: 1000, margin:'0 auto', padding:20}}>
      ...
      <div style={{marginBottom:12, display:'flex', alignItems:'center', gap:10}}>
        <span>외곽선 강조</span>
        <label style={{display:'inline-block', position:'relative', width:50, height:26, cursor:'pointer'}}>
      ...
      <div style={{display:'flex', gap:20}}>
        ...
        <div style={{width:'30%'}}>
          ...
          <div style={{display:'flex', flexDirection:'column', gap:10, maxHeight:'70vh', overflowY:'auto'}}>
            {palette.map((p,i)=>(
              <div key={i} onClick={()=>setSelectedIdx(i===selectedIdx?null:i)}
                style={{
              ...
              >
                <div style={{width:'100%', height:40, borderRadius:6, background:p.hex}} />
